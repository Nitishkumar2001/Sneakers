...
namespace SneakerStore.Repository.Implementation
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<RegisterUserDto> UpdateUser(int Id, RegisterUserDto user)
        {
            var up_User = await _dbContext.Users.SingleOrDefaultAsync(u=>u.Id==Id);
            if (up_User == null)
            {
                return null;
            }
            ...
            await _dbContext.SaveChangesAsync();
            var updatedUserDto = _mapper.Map<RegisterUserDto>(up_User);
