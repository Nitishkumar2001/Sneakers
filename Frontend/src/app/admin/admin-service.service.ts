...
import { AddCategoryDto, Category, OrderItemDto, RequestProductDto, ResponseProductDto, User } from '../models/categories.model';
...
export class AdminServiceService {
  ...
  private baseUrl = 'https://localhost:7019/api/Admin/';
  ...
  UpdateProducts(id: number, product: RequestProductDto): Observable<ResponseProductDto> {
    ...
    return this.http.put<ResponseProductDto>(url, product);
  }
  ...
  getAllOrders(){
    return this.http.get(`${this.baseUrl}GetAllOrders`, this.httpOptions);
  }
}
